...
add_action( 'customize_preview_init', __NAMESPACE__ . '\customizer_library_customize_preview_js' );
...
add_action( 'customize_register', __NAMESPACE__ . '\customizer_library_customize_register' );
